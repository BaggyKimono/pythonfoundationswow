...
Python is an interpreted language, and we can use the Python Console to type any numbers or commands just like a calculator.
...
10 + 5 / 3 - 4 * 12
If you go through this expression in order, as 10 + 5 is 15, dividing by 3 gives us 5 and subtracting 4 leaves us with 1 before dividing by 12. You may be lead to believe the answer is 12 when it is in fact -36.333333333333336 (We see the float because we used the single / divisor)
